...
const restartDiary =
document.getElementById("restartDiary");

const finalButton =
document.querySelector('[data-page="final"]');
...
homePage.style.transform="scale(.96)";
...
finalPage.style.transform="translateY(0)";
...
restartDiary.addEventListener("click",()=>{
...
const finalText =
document.querySelector(".finalText");
...
finalText.style.transform="translateY(30px)";

finalText.style.transition="1.5s ease";
